...
from hummingbot.strategy.day_trade_making.day_trade_making_config_map import day_trade_making_config_map as c_map
...
def start(self):
    try:
        ...
        strategy_logging_options = DayTradeMakingStrategy.OPTION_LOG_ALL

        self.strategy = DayTradeMakingStrategy(
