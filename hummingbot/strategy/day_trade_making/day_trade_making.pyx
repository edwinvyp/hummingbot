...
from .day_trade_making_order_tracker import DayTradeMakingOrderTracker
...
cdef class DayTradeMakingStrategy(StrategyBase):
    ...
    def __init__(self,
        ...
        super().__init__()
        self._sb_order_tracker = DayTradeMakingOrderTracker()
    ...
    def day_mm_assets_df(self, to_show_current_pct: bool) -> pd.DataFrame:
    ...
    def format_status(self) -> str:
        ...
        assets_df = self.day_mm_assets_df(not self._inventory_skew_enabled)
